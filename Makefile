...
LATEXCMD = pdflatex -shell-escape -interaction=nonstopmode -output-directory build/

help:
	@echo "This makefile builds KACTL (ITESM Algorithm Competition Template Library)"
	@echo ""
